...
const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/40 focus-visible:ring-[4px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-[0.99]",
	{
		variants: {
			variant: {
				default:
					'bg-primary text-primary-foreground shadow-[0_12px_30px_-12px_var(--color-primary)] hover:translate-y-[-1px] hover:bg-primary/92',
				destructive:
					'bg-destructive text-white shadow-[0_12px_30px_-12px_rgba(220,38,38,0.6)] hover:bg-destructive/92 focus-visible:ring-destructive/20 dark:bg-destructive/70',
				outline:
					'border border-border/80 bg-background/75 shadow-sm backdrop-blur-sm hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:hover:bg-input/50',
				secondary:
